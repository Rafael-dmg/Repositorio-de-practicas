//Algoritmo centro_de_distribucion_playground
//	definir ventas Como Entero
//	Definir precio, sumVentas Como Real
//	Dimension ventas[4]
//	sum <- 0
////	Repetir
...
////		
////		Escribir cantidad[1]
////	Hasta Que cantidad[1] > 0
//	Para i <- 1 Hasta 4	Hacer
//		ventas[i] = Aleatorio(50, 100)
//	FinPara
////	para i <- 1 Hasta cantidad Con Paso 1 Hacer
////		Escribir "Precio del producto"
////		leer precio
//	para i <- 1 hasta 4 Hacer
//			sumVentas = sum + ventas[i]
//	FinPara
////		sum <- sum + precio
////	FinPara
//	
//	Escribir "el total de ventas es: ", sumVentas
//FinAlgoritmo
Algoritmo centro_de_distribucion
    Definir codCliente, codCiudad, ventas, control, i, maxVentas, centroMaxVentas Como Entero
