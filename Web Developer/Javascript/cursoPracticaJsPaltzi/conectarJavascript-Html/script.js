...
function calcular() {
    ...
    finalResult.innerHTML = `tu resultado es ${resultado}`;
}
...
/* SECCION DE AUTOEVALUACION 1 
 let hi = document.querySelector('#nombre')

function saludar() {
    console.log(`Hola, bienvenido ${hi.value}!, toma asiento la clase esta por comenzar`);
 }
*/